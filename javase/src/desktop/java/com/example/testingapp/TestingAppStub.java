 ...
 * @author Shai Almog
 */
public class TestingAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "TestingApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestingAppStub());
    }
